...
```
cd existing_repo
git remote add origin https://gitlab.com/pgu9104011/pguvinchik.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pgu9104011/pguvinchik/-/settings/integrations)
